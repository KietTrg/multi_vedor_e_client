                        ...
                        <div className='px-8 py-8'>
                            ...
                            <div>
                                <form onSubmit={register} className='text-slate-600'>
                                    ...
                                    <button className='px-8 w-full py-2 bg-purple-500 shadow-lg hover:shadow-indigo-500/30 text-white rounded-md'>{loader ? <HashLoader color='#fff' cssOverride={overideStyle} /> : 'Register'}</button>
                                </form>
                            ...
                            <div className='text-center text-slate-600 pt-1'>
                                <p><a target='_black' className='text-blue-500' href='http://localhost:3000/login'>Login</a> seller account</p>
                            </div>
                        </div>
